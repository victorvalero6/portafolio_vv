...
const TargetCursor = ({
  targetSelector = ".cursor-target, button, a[href], [role='button'], [data-cursor-target]",
  spinDuration = 2,
  ...
  }, [mounted, targetSelector, spinDuration, moveCursor, constants, hideDefaultCursor, isMobile, hoverDuration, parallaxOn, language]);
  ...
  return (
    <>
      <style jsx global>{`
        ...
        /* Keep native cursor for text-entry controls (accessibility/usability). */
        input,
        textarea,
